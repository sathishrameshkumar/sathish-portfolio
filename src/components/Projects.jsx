...
<div className="flex gap-4 mt-8 flex-wrap">
  ...
  {project.demoLink && (
    <a
      ...
      className="bg-cyan-500 hover:bg-cyan-600 px-5 py-3 rounded-xl font-semibold transition duration-300"
    >
      Live Demo
    </a>
  )}
  ...
  {project.sourceCode && (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="border border-cyan-400 hover:bg-cyan-400 hover:text-black px-5 py-3 rounded-xl font-semibold transition duration-300"
    >
      Source Code
    </a>
  )}
